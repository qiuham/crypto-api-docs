---
exchange: gateio
source_url: https://www.gate.com/docs/developers/crossex/zh_CN
api_type: Trading
updated_at: 2026-05-31 19:30:45.657153
---
...
CrossEx 是一个跨交易所交易平台，允许用户通过统一账户在多个交易所（币安、欧易、Gate.io、Bybit、Kraken）进行交易。CrossEx API 提供完整的账户管理、资产划转、下单和仓位管理功能，支持跨交易所操作。
...
如果您在使用过程中有任何问题或建议，可以通过以下方式联系我们：
  ...
  * 提交工单反馈
  * 在线工单反馈
  * 将您的联系信息和问题发送至 [mm@gate.com](mailto:mm@gate.com)，我们将为您分配 技术专家为您服务。
...
CrossEx 是一个跨交易所交易平台，提供以下功能：
  ...
  * 跨多个交易所（币安、欧易、Gate.io、Bybit、Kraken）的统一账户管理
  * 跨交易所资产划转
  * 统一的订单管理和交易
  * 实时仓位和资产监控
  * 支持跨交易所的现货、合约和杠杆交易
...
CrossEx API 主要包括以下功能模块：
  ...
  * **账户管理** ：查询和管理统一账户资产
  * **资产划转** ：在交易所和现货账户之间划转资产
  * **订单管理** ：跨交易所下单、查询和管理订单
  * **仓位管理** ：查询和管理合约和杠杆交易的仓位
  * **市场数据** ：查询交易对、风险限额和市场信息
  * **账户设置** ：配置仓位模式、账户模式和杠杆倍数
...
QUERY_INVALID_EXCHANGE_TYPE | 交易所非法，分所模式下交易所类型必须为BINANCE,OKX,GATE,BYBIT  
...
» default_leverage | string | 默认杠杆倍数  
...
default_leverage | string | false | none | 默认杠杆倍数  
