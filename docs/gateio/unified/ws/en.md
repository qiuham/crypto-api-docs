...
api_type: WebSocket
updated_at: 2026-05-29 19:59:12.986889
---
...
Gate provides a simple and robust Websocket API to integrate Gate unified trade status into your business or application.
...
2024-10-23
  ...
  * init version, support `unified.assets`,`unified.asset_detail` channel
    ...
    func main() {
      u := url.URL{Scheme: "wss", Host: "ws.gate.com", Path: "/v4/ws/unified"}
...
**Gate unified use the protocol layer ping/pong message.The server will initiate a ping message actively. If the client does not reply, the client will be disconnected.**
