---
exchange: binance
source_url: https://developers.binance.com/docs/derivatives/usds-margined-futures/common-definition
api_type: REST
updated_at: 2026-01-15T23:46:36.484581
---
...
### PRICE_FILTER[​](/docs/derivatives/usds-margined-futures/common-definition#price_filter "Direct link to PRICE_FILTER")
...
### LOT_SIZE[​](/docs/derivatives/usds-margined-futures/common-definition#lot_size "Direct link to LOT_SIZE")
...
### MARKET_LOT_SIZE[​](/docs/derivatives/usds-margined-futures/common-definition#market_lot_size "Direct link to MARKET_LOT_SIZE")
...
### MAX_NUM_ORDERS[​](/docs/derivatives/usds-margined-futures/common-definition#max_num_orders "Direct link to MAX_NUM_ORDERS")
...
### MAX_NUM_ALGO_ORDERS[​](/docs/derivatives/usds-margined-futures/common-definition#max_num_algo_orders "Direct link to MAX_NUM_ALGO_ORDERS")
...
### PERCENT_PRICE[​](/docs/derivatives/usds-margined-futures/common-definition#percent_price "Direct link to PERCENT_PRICE")
...
### MIN_NOTIONAL[​](/docs/derivatives/usds-margined-futures/common-definition#min_notional "Direct link to MIN_NOTIONAL")
...
## 术语解释[​](/docs/zh-CN/derivatives/usds-margined-futures/common-definition#术语解释 "术语解释的直接链接")
...
## 枚举定义[​](/docs/zh-CN/derivatives/usds-margined-futures/common-definition#枚举定义 "枚举定义的直接链接")
...
## 交易对过滤器[​](/docs/zh-CN/derivatives/usds-margined-futures/common-definition#交易对过滤器 "交易对过滤器的直接链接")

#### PRICE_FILTER 价格过滤器[​](/docs/zh-CN/derivatives/usds-margined-futures/common-definition#price_filter-价格过滤器 "PRICE_FILTER 价格过滤器的直接链接")
...
### LOT_SIZE 订单尺寸[​](/docs/zh-CN/derivatives/usds-margined-futures/common-definition#lot_size-订单尺寸 "LOT_SIZE 订单尺寸的直接链接")
...
### MARKET_LOT_SIZE 市价订单尺寸[​](/docs/zh-CN/derivatives/usds-margined-futures/common-definition#market_lot_size-市价订单尺寸 "MARKET_LOT_SIZE 市价订单尺寸的直接链接")

参考LOT_SIZE，区别仅在于对市价单还是限价单生效

### MAX_NUM_ORDERS 最多订单数[​](/docs/zh-CN/derivatives/usds-margined-futures/common-definition#max_num_orders-最多订单数 "MAX_NUM_ORDERS 最多订单数的直接链接")
...
### MAX_NUM_ALGO_ORDERS 最多条件订单数[​](/docs/zh-CN/derivatives/usds-margined-futures/common-definition#max_num_algo_orders-最多条件订单数 "MAX_NUM_ALGO_ORDERS 最多条件订单数的直接链接")
...
### PERCENT_PRICE 价格振幅过滤器[​](/docs/zh-CN/derivatives/usds-margined-futures/common-definition#percent_price-价格振幅过滤器 "PERCENT_PRICE 价格振幅过滤器的直接链接")
...
### MIN_NOTIONAL 最小名义价值[​](/docs/zh-CN/derivatives/usds-margined-futures/common-definition#min_notional-最小名义价值 "MIN_NOTIONAL 最小名义价值的直接链接")
