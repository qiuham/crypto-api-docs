...
api_type: WebSocket
updated_at: 2026-01-15T23:40:23.868810
---
...
## SIGNED (TRADE and USER_DATA) Endpoint Security[​](/docs/derivatives/coin-margined-futures/websocket-api-general-info#signed-trade-and-user_data-endpoint-security "Direct link to SIGNED \(TRADE and USER_DATA\) Endpoint Security")
...
* Base url为：**'wss://ws-dapi.binance.com/ws-dapi/v1'**
    * 测试网的Base url为：`wss://testnet.binancefuture.com/ws-dapi/v1`
  ...
  * **用户数据流请求 - 您需要建立单独的WebSocket连接来获得 [账户信息推送]（[https://developers.binance.com/docs/derivatives/coin-margined-futures/user-data-streams）](https://developers.binance.com/docs/derivatives/coin-margined-futures/user-data-streams%EF%BC%89)**



## WebSocket API响应格式[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#websocket-api响应格式 "WebSocket API响应格式的直接链接")
...
`status` | INT | YES | 响应状态。请看 [状态代码](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#状态代码)  
`result` | OBJECT / ARRAY | YES | 响应内容。请求成功则显示  
`error` | OBJECT | 错误描述。请求失败则显示  
`rateLimits` | ARRAY | NO | 速率限制状态。请看 [速率限制](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#速率限制)  
  
## WebSocket API访问限制[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#websocket-api访问限制 "WebSocket API访问限制的直接链接")
  ...
  * 例如，使用 `wss://ws-dapi.binance.com/ws-dapi/v1?returnRateLimits=false` 默认在响应中隐藏 `rateLimits`。在这样的情况下，您可以在请求中传递额外的 `"returnRateLimits": true` 参数，当默认隐藏时，就可以在响应中显示速率限制。



## WebSocket API连接后进行身份验证[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#websocket-api连接后进行身份验证 "WebSocket API连接后进行身份验证的直接链接")

你可以使用会话身份验证请求对已经建立的连接进行身份验证：

  * [`session.logon`](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#log-in-with-api-key-signed) – 进行身份验证，或更改与连接相关联的API密钥。
  * [`session.status`](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#query-session-status) – 检查连接状态和当前API密钥。
  * [`session.logout`](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#log-out-of-the-session) – 忘记与连接关联的API密钥。



## WebSocket API关于吊销API密钥[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#websocket-api关于吊销api密钥 "WebSocket API关于吊销API密钥的直接链接")
...
## WebSocket API授权 _临时_ 请求[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#websocket-api授权-临时-请求 "websocket-api授权-临时-请求的直接链接")
...
## WebSocket API身份验证请求[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#websocket-api身份验证请求 "WebSocket API身份验证请求的直接链接")

**注意：** 仅支持 _Ed25519_ 密钥用于此功能。

### 用API key登录 (SIGNED)[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#用api-key登录-signed "用API key登录 \(SIGNED\)的直接链接")
...
### 查询会话状态[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#查询会话状态 "查询会话状态的直接链接")
...
### 退出会话[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#退出会话 "退出会话的直接链接")
...
## SIGNED (TRADE and USER_DATA) 请求安全[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#signed-trade-and-user_data-请求安全 "SIGNED \(TRADE and USER_DATA\) 请求安全的直接链接")

### SIGNED 请求示例 (Ed25519)[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-api-general-info#signed-请求示例-ed25519 "SIGNED 请求示例 \(Ed25519\)的直接链接")
