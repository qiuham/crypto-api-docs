---
exchange: binance
source_url: https://developers.binance.com/docs/binance-spot-api-docs/demo-mode/DEMO-TERMS-OF-USE
api_type: REST
updated_at: 2026-05-31 18:31:37.087927
---
...
## SPOT 测试网（Testnet）和 SPOT 模拟交易（Demo Mode）的区别是什么？[​](/docs/zh-CN/binance-spot-api-docs/demo-mode/general-info#spot-测试网testnet和-spot-模拟交易demo-mode的区别是什么 "SPOT 测试网（Testnet）和 SPOT 模拟交易（Demo Mode）的区别是什么？的直接链接")
