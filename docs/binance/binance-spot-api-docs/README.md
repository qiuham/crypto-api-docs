...
[sbe_schemas](/docs/binance-spot-api-docs/sbe/schemas/)| Spot Simple Binary Encoding (SBE) schemas  
...
Name| Description  
---|---  
[api_key_types](/docs/binance-spot-api-docs/faqs/api_key_types)| API Key Types  
[spot_glossary](/docs/binance-spot-api-docs/faqs/spot_glossary)| Definition of terms used in the API  
[commission_faq](/docs/binance-spot-api-docs/faqs/commission_faq)| Explaining commission calculations on the API  
...
[stp_faq](/docs/binance-spot-api-docs/faqs/stp_faq)| Detailed Information on the behavior of Self Trade Prevention (aka STP) on the API  
[market_orders_faq](/docs/binance-spot-api-docs/faqs/market_orders_faq.md)| Detailed information on the behavior of Market Orders  
...
[sor_faq](/docs/binance-spot-api-docs/faqs/sor_faq)| Smart Order Routing (SOR)  
[order_count_decrement](/docs/binance-spot-api-docs/faqs/order_count_decrement)| Updates to the Spot Order Count Limit Rules.  
[order_amend_keep_priority](/docs/binance-spot-api-docs/faqs/order_amend_keep_priority)| Detailed Information on the behavior of Order Amend Keep Priority  
[pegged_orders](/docs/binance-spot-api-docs/faqs/pegged_orders)| Detailed Information on Pegged Orders  
[sbe_faq](/docs/binance-spot-api-docs/faqs/sbe_faq)| Information on the implementation of Simple Binary Encoding (SBE) on the API  
...
### 币安API文档[​](/docs/zh-CN/binance-spot-api-docs/README#币安api文档 "币安API文档的直接链接")
...
文档名| 描述  
---|---  
[enums_CN.md](/docs/zh-CN/binance-spot-api-docs/enums)| 适用于 Rest API 和 WebSocket API 的枚举定义  
[errors_CN.md](/docs/zh-CN/binance-spot-api-docs/errors)| 现货 API 的错误代码及含义  
[filters_CN.md](/docs/zh-CN/binance-spot-api-docs/filters)| 现货 API 使用的过滤器的详细信息  
[rest-api_CN.md](/docs/zh-CN/binance-spot-api-docs/rest-api.md)| 现货 Rest API 接口定义 (`/api`)  
[fix-api_CN.md](/docs/zh-CN/binance-spot-api-docs/fix-api)| 现货 FIX API  
[web-socket-api_CN.md](/docs/zh-CN/binance-spot-api-docs/web-socket-api.md)| 现货 WebSocket API  
[web-socket-streams_CN.md](/docs/zh-CN/binance-spot-api-docs/web-socket-streams)| 现货行情数据流接口的描述  
[sbe-market-data-streams_CN.md](/docs/zh-CN/binance-spot-api-docs/sbe-market-data-streams)| SBE 市场数据流  
[user-data-stream_CN.md](/docs/zh-CN/binance-spot-api-docs/user-data-stream)| 现货用户数据流接口的描述  
[sbe_schemas](/docs/zh-CN/binance-spot-api-docs/sbe/schemas/)| 现货API的简单二进制编码 (SBE)模式 (Schema)  
|   
...
### 常见问题[​](/docs/zh-CN/binance-spot-api-docs/README#常见问题 "常见问题的直接链接")

名称| 描述  
---|---  
[api_key_types](/docs/zh-CN/binance-spot-api-docs/faqs/api_key_types)| API 密钥类型  
[spot_glossary_CN](/docs/zh-CN/binance-spot-api-docs/faqs/spot_glossary)| 现货交易 API 术语表  
[commission_faq_CN](/docs/zh-CN/binance-spot-api-docs/faqs/commission_faq)| 解释 API 上所使用的佣金计算方式  
[trailing_stop_faq_CN](/docs/zh-CN/binance-spot-api-docs/faqs/trailing-stop-faq)| 追踪止盈止损订单(Trailing Stop)详细信息和常见问题  
[stp_faq_CN](/docs/zh-CN/binance-spot-api-docs/faqs/stp_faq)| 关于 Self Trade Prevention (STP) 的详细信息  
[market_orders_faq_CN](/docs/zh-CN/binance-spot-api-docs/faqs/market_orders_faq.md)| 关于市价单行为的详细信息  
[market_data_only_CN](/docs/zh-CN/binance-spot-api-docs/faqs/market_data_only)| 仅提供市场数据的 API 和 WebSocket Streams  
[sor_faq_CN](/docs/zh-CN/binance-spot-api-docs/faqs/sor_faq)| 智能指令路由 (SOR)  
[order_amend_keep_priority_CN](/docs/zh-CN/binance-spot-api-docs/faqs/order_amend_keep_priority)| 关于修改订单并保留其优先级的详细信息  
[pegged_orders](/docs/zh-CN/binance-spot-api-docs/faqs/pegged_orders)| 关于挂钩订单的详细信息  
[order_count_decrement_CN](/docs/zh-CN/binance-spot-api-docs/faqs/order_count_decrement)| 现货下单频率限制的更新  
[sbe_faq_CN](/docs/zh-CN/binance-spot-api-docs/faqs/sbe_faq)| 关于在 API 上实施简单二进制编码 (SBE) 的信息  
  
### 更新日志[​](/docs/zh-CN/binance-spot-api-docs/README#更新日志 "更新日志的直接链接")

关于 API 和数据流方面的最新变动，请参考 [更新日志](/docs/zh-CN/binance-spot-api-docs/CHANGELOG)。

### 相关信息[​](/docs/zh-CN/binance-spot-api-docs/README#相关信息 "相关信息的直接链接")
...
### 联系我们[​](/docs/zh-CN/binance-spot-api-docs/README#联系我们 "联系我们的直接链接")
