...
api_type: REST
updated_at: 2026-01-15T23:36:31.614433
---
...
Read [Order Amend Keep Priority FAQ](/docs/binance-spot-api-docs/testnet/faqs/order_amend_keep_priority.md) to learn more.
...
Sent by the client to query information about active instruments (i.e., those that have the TRADING status). If used for an inactive instrument, it will be responded to with a [Reject`<3>`](/docs/binance-spot-api-docs/testnet/fix-api#reject).
...
=>969| MinPriceIncrement| PRICE| N| Corresponds to the [PRICE](/docs/binance-spot-api-docs/testnet/filters#price) filter  
=>2551| StartPriceRange| PRICE| N| Corresponds to the [PRICE](/docs/binance-spot-api-docs/testnet/filters#price) filter  
=>2552| EndPriceRange| PRICE| N| Corresponds to the [PRICE](/docs/binance-spot-api-docs/testnet/filters#price) filter  
...
### FIX Connection Lifecycle[​](/docs/zh-CN/binance-spot-api-docs/testnet/fix-api#fix-connection-lifecycle "FIX Connection Lifecycle的直接链接")
  ...
  * All FIX API sessions will remain open for as long as possible, on a best-effort basis.
  * There is no minimum connection time guarantee; a server can enter maintenance at any time. 
    * When a server enters maintenance, a [News `<B>`](/docs/zh-CN/binance-spot-api-docs/testnet/fix-api#news) message will be sent to clients **every 10 seconds for 10 minutes** , prompting clients to reconnect. Upon receiving this message, a client is expected to establish a new session and close the old one. If the client does not close the old session within the time frame, the server will proceed to log it out and close the session.
...
#### NewOrderSingle `<D>`[​](/docs/zh-CN/binance-spot-api-docs/testnet/fix-api#newordersingle-d "newordersingle-d的�直接链接")
...
Read [Order Amend Keep Priority FAQ](/docs/zh-CN/binance-spot-api-docs/testnet/faqs/order_amend_keep_priority.md) to learn more.
...
Sent by the client to query information about active instruments (i.e., those that have the TRADING status). If used for an inactive instrument, it will be responded to with a [Reject`<3>`](/docs/zh-CN/binance-spot-api-docs/testnet/fix-api#reject).
...
=>969| MinPriceIncrement| PRICE| N| Corresponds to the [PRICE](/docs/zh-CN/binance-spot-api-docs/testnet/filters#price) filter  
=>2551| StartPriceRange| PRICE| N| Corresponds to the [PRICE](/docs/zh-CN/binance-spot-api-docs/testnet/filters#price) filter  
=>2552| EndPriceRange| PRICE| N| Corresponds to the [PRICE](/docs/zh-CN/binance-spot-api-docs/testnet/filters#price) filter  
