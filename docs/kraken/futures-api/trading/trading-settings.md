...
api_type: REST
updated_at: 2026-05-31 19:19:13.518308
---

# Initiate wallet transfer

**POST** `https://futures.kraken.com/derivatives/api/v3/transfer`
...
* CURL
    ...
    curl -L -X POST 'https://futures.kraken.com/derivatives/api/v3/transfer' \  
