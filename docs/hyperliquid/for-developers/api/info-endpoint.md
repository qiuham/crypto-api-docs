...
api_type: REST
updated_at: 2026-06-05 18:44:32.340766
---
...
---|---|---  
req*| Object| {"coin": <coin>, "interval": "15m", "startTime": <epoch millis>, "endTime": <epoch millis>} For HIP-3, you need to prefix with the dex name, e.g. "xyz:XYZ100"  
...
type*| String| "borrowLendUserState"  
---|---|---  
user*| String| hexadecimal format; e.g. 0x0000000000000000000000000000000000000000.  
...
type*| String| "borrowLendReserveState"  
---|---|---  
token*| Number| token index  
...
type*| String| "allBorrowLendReserveStates"  
---|---|---  
